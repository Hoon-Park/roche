@MenuItem ("ROCHE/Generar Coordenadas de Textura")
static function doMeshes() {
	if(!EditorUtility.DisplayDialog("Confirmacion", "¿Alterar coordenadas de textura para los objetos seleccionados?", "Confirmar", "Cancelar")) return;
